...
$sql = 'SELECT mannames.Fname, mannames.Mname, mannames.Lname, manager.Email, manager.Area_code, Manager.Local_phone FROM manager, mannames WHERE Manager.managerID=mannames.ManID ORDER BY ManagerID';
