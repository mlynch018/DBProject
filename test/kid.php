...
$sql = 'SELECT professionals.Fname, professionals.Mname, professionals.Lname FROM professionals, child WHERE child.ProfID = professionals.IDno GROUP BY child.ProfID;';
