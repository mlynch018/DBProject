...
$sql = 'SELECT * FROM PROFESSIONALS,UNIONS,MANAGER WHERE Unions.UnionID=Professionals.UID AND Manager.ManagerID=Professionals.ManID ORDER BY Professionals.IDno';
				...
				<div class="col s6 md3">
					<div class="card z-depth-0">
						<div class="card-content center">
							...
							<div><?php echo "Manager Email: " ; echo htmlspecialchars($prof['Email']);?></div>
